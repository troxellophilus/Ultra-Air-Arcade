...
void initGround() {
    Terrain terrain = Terrain("../Assets/heightmap/TamrielLoRes.bmp", 100.0, terPosBuf, terIndBuf, terNorBuf);
...
int main(int argc, char **argv) {
    ...
    player.setScale(glm::vec3(0.5,0.5,0.5)); //all .2
   ...
   for(int i = 0; i < opponents.size(); i++){
      ...
      drawVBO(&opponents.at(i), pIndices, PLANE);
   }   
